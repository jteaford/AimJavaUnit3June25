...
public class MyPoint {
    ...
    // A member method named distance that calculates and returns the distance between this MyPoint object and another 
    // object of the MyPoint class. The method header looks like this: public double distance(MyPoint p)
    ...
    // A static, non-member method named distance that takes two objects of the MyPoint class as parameters, and 
    // calculates and returns the distance between the two of them. The method header looks like this: 
